...
#define CMDLINE_PARSER_PACKAGE "rocmdr_snp"
#endif

#ifndef CMDLINE_PARSER_PACKAGE_NAME
/** @brief the complete program name (used for help and version) */
#define CMDLINE_PARSER_PACKAGE_NAME "rocmdr_snp"
#endif
...
struct gengetopt_args_info
{
  ...
  int verbose_flag;	/**< @brief Outputs extra information during run. (default=off).  */
  const char *verbose_help; /**< @brief Outputs extra information during run. help description.  */
